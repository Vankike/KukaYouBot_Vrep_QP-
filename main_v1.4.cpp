...
// La ultima modificación incluye la retroalimentación de Vrep, regresando las posiciones de los efectores finales, el objeto y la pose(X,Theta) de la base de los youbot. 
// al 09/abril/2019
  ...
  public:
    ...
    KUKA () { // Constructor. Parameters of the KUKAyouBot
        ...
        *******************************************************************************/
        ...
        // Q(O) ponerlo diferente de 0 para que termine la cond. del while (cubo[0] > -0.01 && cubo[0] < 0.01)
        Q  <<  0,  -1,  0 ,  0 , 0.2, -0.1, 0.02,  0;
        Q2  <<  -0.85,  -1 ,  0 ,  0 , 0.2, -0.1, 0.02,  0;
    ...
    void QPsolver(int clientID)
        {
            ...
            int wheel_rl, wheel_rr,wheel_fl,wheel_fr,joint1, joint2, joint3, joint4, joint5,
                wheel_rl2, wheel_rr2,wheel_fl2,wheel_fr2,joint1_2, joint2_2, joint3_2, joint4_2, joint5_2,
                 baseX,Ox,Ox2, baseX2,youBot_Tip,youBot_Tip2, leftTarget, rightTarget;
            ...
            if (valido1 != 0 || valido2 != 0 || valido3 != 0 || valido4 != 0 || valido5 != 0 || valido6 != 0 || valido7 != 0  || valido8 != 0 || valido9 != 0 || valido10 != 0 || valido11 != 0 || valido12 != 0 || valido13 != 0 || valido14 != 0 || valido15 != 0 || valido16 != 0 || valido17 != 0 || valido18 != 0 || valido81 != 0 || valido19 != 0 ||  valido21 != 0 || valido22 != 0 || valido23 != 0 || valido24 != 0 || valido25 != 0 || valido26 != 0)
            {
                std::cout << "ERROR: Unable to connect with V-rep \n";
                std::cout << "Possible reason: Bodies not detected \n";
                simxFinish(clientID);
                exit(1);
            }
            ...
            simxGetObjectPosition(clientID,baseX2,-1,&prismaticos2[0],simx_opmode_streaming);
            simxGetObjectPosition(clientID,youBot_Tip,-1,&tip[0],simx_opmode_streaming);
            simxGetObjectPosition(clientID,youBot_Tip2,-1,&tip2[0],simx_opmode_streaming);
            simxGetObjectPosition(clientID,leftTarget,-1,&desired[0],simx_opmode_streaming);
            simxGetObjectPosition(clientID,rightTarget,-1,&desired[0],simx_opmode_streaming);
            simxGetObjectOrientation(clientID, Ox,-1, &baseRot[0] ,simx_opmode_streaming);
            simxGetObjectOrientation(clientID, Ox2,-1, &baseRot2[0] ,simx_opmode_streaming);
            ...
            simxSetJointPosition(clientID, joint5_2, Q2(7), simx_opmode_streaming);
             while( true){
                 ...
                 simxGetObjectPosition(clientID,baseX2,-1,&prismaticos2[0],simx_opmode_buffer);
                 simxGetObjectPosition(clientID,youBot_Tip,-1,&tip[0],simx_opmode_buffer);
                 simxGetObjectPosition(clientID,youBot_Tip2,-1,&tip2[0],simx_opmode_buffer);
                 simxGetObjectPosition(clientID,leftTarget,-1,&desired[0],simx_opmode_buffer);
                 simxGetObjectPosition(clientID,rightTarget,-1,&desired2[0],simx_opmode_buffer);
                 simxGetObjectOrientation(clientID, Ox,-1, &baseRot[0] ,simx_opmode_buffer);
                 simxGetObjectOrientation(clientID, Ox2,-1, &baseRot2[0] ,simx_opmode_buffer);
                 if(prismaticos[0] > -1.1 && prismaticos[0] < -0.9 && prismaticos2[0] > -1.1 && prismaticos2[0] < -0.9){
                    break;
                 }
                 std::cout<<"loading positions ..."<<std::endl;
             }

            //simxGetJointPosition(clientID,joint1,position,simx_opmode_streaming);
             Q(0) = prismaticos[1];
             Q(1) = prismaticos[0];
             Q(2) = baseRot[2];
             Q2(0) = prismaticos2[1];
             Q2(1) = prismaticos2[0];
             Q2(2) = baseRot2[2];
             pos<< tip[0], tip[1], tip[2];
             pos2<< tip2[0], tip2[1], tip2[2];
             posD<< desired[0], desired[1], desired[2];
             posD2<< desired2[0], desired2[1], desired2[2];
            ...
            for (int i=1;i<NN;i++){
                ...
                */
                ...
                simxSetJointTargetVelocity(clientID,wheel_fl,(-QDot(1) +QDot(0) +QDot(2))*20,simx_opmode_streaming);
                simxSetJointTargetVelocity(clientID,wheel_rl,(-QDot(1) -QDot(0) +QDot(2))*20,simx_opmode_streaming);
                simxSetJointTargetVelocity(clientID,wheel_rr,(-QDot(1) +QDot(0) -QDot(2))*20,simx_opmode_streaming);
                simxSetJointTargetVelocity(clientID,wheel_fr,(-QDot(1) -QDot(0) -QDot(2))*20,simx_opmode_streaming);
                simxSetJointTargetVelocity(clientID,wheel_fl2,(-Q2Dot(1) +Q2Dot(0) +Q2Dot(2))*20,simx_opmode_oneshot);
                simxSetJointTargetVelocity(clientID,wheel_rl2,(-Q2Dot(1) -Q2Dot(0) +Q2Dot(2))*20,simx_opmode_oneshot);
                simxSetJointTargetVelocity(clientID,wheel_rr2,(-Q2Dot(1) +Q2Dot(0) -Q2Dot(2))*20,simx_opmode_oneshot);
                simxSetJointTargetVelocity(clientID,wheel_fr2,(-Q2Dot(1) -Q2Dot(0) -Q2Dot(2))*20,simx_opmode_oneshot);
                simxSetJointPosition(clientID, joint1, Q(3), simx_opmode_streaming);
                simxSetJointPosition(clientID, joint2, Q(4), simx_opmode_streaming);
                simxSetJointPosition(clientID, joint3, Q(5), simx_opmode_streaming);
                simxSetJointPosition(clientID, joint4, Q(6), simx_opmode_streaming);
                ...
                SavetoFile(dataFile, dataFile2,dataFile3,dataFile4,dataFile5,Q2DDot,Q2Dot,Q2,err2,FT);
                msleep(3);
            }
