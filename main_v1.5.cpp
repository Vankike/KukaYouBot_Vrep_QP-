// esta version no esta terminada, presenta errores y no ha cambiado mucho que la v. 1.4
    ...
    void QPsolver(int clientID)
        {
            ...
            while( true){
                 ...
                 if(prismaticos[0] > -1.1 && prismaticos[0] < -0.9 && prismaticos2[0] > -1.6 && prismaticos2[0] < -1.4){
                    break;
                 }
            ...
            for (int i=1;i<NN;i++){
                ...
                //std::cout<< "Qs"<<"\n"<< Q<<std::endl;
                //std::cout<< "quater actual"<<"\n"<< o4<<std::endl;
                //std::cout<< "Qs 2"<<"\n"<< Q2<<std::endl;
                //std::cout<< "quater2 actual"<<"\n"<< o4_2<<std::endl;
               // exit(1);
                ...
                */
                ...
                std::cout << "+-----------------------------------------" << std::endl
                    ...
                    << "|  eQw" << "\t\t" << "------" << "\t\t" << o4_2(0) <<"\t\t" << od4_2(0)<< std::endl
                    << "|  eQx" << "\t\t" << eQ2(0) << "\t\t" << o4_2(1) <<"\t\t" << od4_2(1)<< std::endl
                    << "|  eQy" << "\t\t" << eQ2(1) << "\t\t" << o4_2(2) <<"\t\t" << od4_2(2)<< std::endl
                    << "|  eQz" << "\t\t" << eQ2(2) << "\t\t" << o4_2(3) <<"\t\t" << od4_2(3)<< std::endl
                    << "+-----------------------------------------" << std::endl;
