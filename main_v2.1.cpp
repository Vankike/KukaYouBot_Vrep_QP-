...
class KUKA{
 ...
 private:
    ...
    double l1,l2,l3,l4,l5,l6,l7, t0, tEnd, delta,delta2, KP, KD,Kwh,Krot, Num_Iter, delay,mObj,normfc,
           a1,a2,b1,b2,c1,c2, PcPr_Norma, gainKI, ProdEscalar, Vmax, Vmin, EscalarVN, Vclamp;
           ...
           for (int i=1;i<NN;i++){
                ...
                */
                ...
                if (i >= 2500){
                    ...
                    //bAc = - KP*( pos - QCLAMP ) - KD*( Vnu.block(0,0,3,1) -V_filter ) -deriva.block(0,0,3,1) + ACLAMP;
                    bAc = - KP*( V_filter ) - KD*( ACLAMP  ) -deriva.block(0,0,3,1);

                    lbA2 << -h,bAc(0),bA.block(1,0,5,1), QI;
                    ubA2 << -h,bAc(0),bA.block(1,0,5,1), QS;
                   //lbA2 << -h,bA, QI;
                    //ubA2 << -h,bA, QS;
                ...
                Datos << ForceSensed , xOpt1.segment(16,3), VCLAMP(0) , V_filter(0);
/*
