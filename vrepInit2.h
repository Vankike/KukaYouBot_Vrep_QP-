...
private:
    ...
    wheel_rl2, wheel_rr2,wheel_fl2,wheel_fr2,joint1_2, joint2_2, joint3_2, joint4_2, joint5_2,
     baseX,Ox,Ox2, baseX2,youBot_Tip,youBot_Tip2, Pc, Pk,Pj, WorldFrame2,  worldx,worldy, baseangle,Force_sensor,
    worldx2,worldy2, baseangle2;
    int valido[16];
    float prismaticos[3],baseRot[3],tip[3],desired[3],PuntoK[3],PuntoJ[3],prismaticos2[3],baseRot2[3],tip2[3],force[3],torque[3];
    double Kwh,Krot;
    unsigned char Fsensor_state[1];
public:
    Simulador(VectorXd Q, bool wheelsON);
