    ...
    void QPsolver(int clientID)
        {
            ...
            int valido9 = simxGetObjectHandle(clientID, "Joint1#0", &joint1_2, simx_opmode_blocking);
            int valido10 = simxGetObjectHandle(clientID, "Joint2#0", &joint2_2, simx_opmode_blocking);
            int valido11 = simxGetObjectHandle(clientID, "Joint3#0", &joint3_2, simx_opmode_blocking);
            int valido12 = simxGetObjectHandle(clientID, "Joint4#0", &joint4_2, simx_opmode_blocking);
            int valido13 = simxGetObjectHandle(clientID, "Joint5#0", &joint5_2, simx_opmode_blocking);
            ...
            if (valido1 != 0 || valido2 != 0 || valido3 != 0 || valido4 != 0 || valido5 != 0 || valido6 != 0 || valido7 != 0 || valido8 != 0 || valido9 != 0 || valido10 != 0 || valido11 != 0 || valido12 != 0 || valido13 != 0 || valido14 != 0 || valido15 != 0 || valido16 != 0)
            {
                std::cout << "ERROR: Unable to connect with V-rep \n";
                simxFinish(clientID);
