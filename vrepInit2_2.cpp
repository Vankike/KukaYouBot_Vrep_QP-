...
Simulador::Simulador(VectorXd Q, bool wheelsON,double KWH,double KROT){
    ...
    simxGetObjectOrientation(clientID, Force_sensor,-1, &OriFsensor[0],simx_opmode_streaming);
    simxReadForceSensor(clientID, Force_sensor,&Fsensor_state[0],&force[0], &torque[0],simx_opmode_streaming);
    simxGetJointPosition(clientID, joint1, &J1[0], simx_opmode_streaming);
    simxGetJointPosition(clientID, joint2, &J2[0], simx_opmode_streaming);
    simxGetJointPosition(clientID, joint3, &J3[0], simx_opmode_streaming);
    simxGetJointPosition(clientID, joint4, &J4[0], simx_opmode_streaming);
    simxGetJointPosition(clientID, joint5, &J5[0], simx_opmode_streaming);
    ...
    for(int j=0; j<=280000; j++){
         ...
         simxGetObjectOrientation(clientID, Force_sensor,-1, &OriFsensor[0],simx_opmode_buffer);
         simxReadForceSensor(clientID, Force_sensor,&Fsensor_state[0],&force[0], &torque[0],simx_opmode_buffer);
         simxGetJointPosition(clientID, joint1, &J1[0], simx_opmode_buffer);
         simxGetJointPosition(clientID, joint2, &J2[0], simx_opmode_buffer);
         simxGetJointPosition(clientID, joint3, &J3[0], simx_opmode_buffer);
         simxGetJointPosition(clientID, joint4, &J4[0], simx_opmode_buffer);
         simxGetJointPosition(clientID, joint5, &J5[0], simx_opmode_buffer);

         std::cout<<"loading positions ..."<<j<<std::endl<<std::endl;
         // dfsdfsdfs
     }
    ...
    resp << prismaticos[1], prismaticos[0], baseRot[2],
            ...
            OriFsensor[0], OriFsensor[1], OriFsensor[2],J1[0],J2[0],J3[0],J4[0],J5[0];
}
...
VectorXd Simulador::connect(VectorXd Q,VectorXd QDot, bool wheelsON){
     ...
     simxSetJointPosition(clientID, joint5, Q(7), simx_opmode_streaming);
     */
     simxSetJointTargetVelocity(clientID, joint1, QDot(3), simx_opmode_streaming);
     simxSetJointTargetVelocity(clientID, joint2, QDot(4), simx_opmode_streaming);
     simxSetJointTargetVelocity(clientID, joint3, QDot(5), simx_opmode_streaming);
     simxSetJointTargetVelocity(clientID, joint4, QDot(6), simx_opmode_streaming);
     simxSetJointTargetVelocity(clientID, joint5, QDot(7), simx_opmode_streaming);
